...
describe UsersController do
  ...
  it 'requires login on signup' do
    lambda do
      ...
      assigns[:users].errors.on(:login).should_not be_nil
  ...
  it 'requires password on signup' do
    lambda do
      ...
      assigns[:users].errors.on(:password).should_not be_nil
      response.should be_success
    end.should_not change(Users, :count)
  end
  ...
  it 'requires password confirmation on signup' do
    lambda do
      ...
      assigns[:users].errors.on(:password_confirmation).should_not be_nil
      response.should be_success
    end.should_not change(Users, :count)
  end
  ...
  it 'requires email on signup' do
    lambda do
      ...
      assigns[:users].errors.on(:email).should_not be_nil
      response.should be_success
    end.should_not change(Users, :count)
  end
